...
<table id="table_96AEBFF29F3D40CAA859133B22756B0C"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Prove dei revisori </p> </td> 
   <td colname="col2"> <p> Aggiunte <a href="run-debugger.md#section-82bc57440406461ebf27a16855b71655" format="dita" scope="local"> prove Auditor</a> a Debugger </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Adobe Audience Manager </p> </td> 
   <td colname="col2"> <p>Debugger ora visualizza le risposte AAM </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Aggiornamento del piè di pagina di Debugger
...
* È stato risolto un problema per cui Debugger continuava a sostituire i codici da incorporare anche quando la finestra di Debugger era chiusa
...
<table id="table_9AC6DE90AF4345DFA707BFBA1E58C328"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dalla scheda Strumenti, è possibile inserire in modo dinamico Launch in qualsiasi pagina per eseguire il test su una pagina in cui non è installato Launch. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E847A9D6711F4CF59E98806FA7AF8379"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Aggiunto un collegamento ad Auditor da Debugger </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8FDED5A7B7F7430A88AE441336F9C714"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Aggiorna il collegamento della guida a piè di pagina a <a href="https://docs.adobe.com/content/help/it-IT/debugger/using/experience-cloud-debugger.html" format="https" scope="external"> https://docs.adobe.com/content/help/en/debugger/using/experience-cloud-debugger.html</a> </p> </td> 
  </tr> 
 </tbody> 
</table>
