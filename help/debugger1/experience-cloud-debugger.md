...
1. Utilizza [Launch](https://docs.adobelaunch.com) o [DTM](https://experiencecloud.adobe.com/resources/help/en_US/dtm/) per inserire il codice necessario per attivare le soluzioni [Adobe Experience Cloud](https://marketing.adobe.com/resources/help/en_US/mcloud/) nelle tue pagine.
